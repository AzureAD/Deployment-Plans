...
-   **Custom Attribute Stores:** Azure AD now supports custom authentication
    ...
    AD attributes, for more information on how to configure these attributes and the current requirements visit [custom extension overview](https://learn.microsoft.com/azure/active-directory/develop/custom-extension-overview).
